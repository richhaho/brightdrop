                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a href="#" class="btn btn-success pull-right" style="margin-top: 25px"><i class="" data-toggle="modal" data-target="#modal-approve-{{$adjustment->id}}">Approve</i></a>
                                        @component('payroll.adjustment.components_onetime.approvemodal')
                                        @slot('id') 
                                            {{ $adjustment->id }}
                                        @endslot
                                        @endcomponent
                                        @component('payroll.adjustment.components_onetime.declinemodal')
                                        @slot('id') 
                                            {{ $adjustment->id }}
                                        @endslot
                                        @endcomponent
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a href="#" class="btn btn-success pull-right" style="margin-top: 25px"><i class="" data-toggle="modal" data-target="#modal-approve-r{{$adjustment->id}}">Approve</i></a>
                                        @component('payroll.adjustment.components_recurring.approvemodal')
                                        @slot('id') 
                                            {{ $adjustment->id }}
                                        @endslot
                                        @endcomponent
                                        @component('payroll.adjustment.components_recurring.declinemodal')
                                        @slot('id') 
                                            {{ $adjustment->id }}
                                        @endslot
                                        @endcomponent
