    ...
    <section id="Cash_advance">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <h3 class="bold">Active -  Cash Advances</h3>
                    </div>
                </div>
            </div>
            ...
            {!! Form::open(['route' => 'payroll.updateCashAdvance','autocomplete' => 'off']) !!}
                        ...
                        <div class="panel-body">
                            <div class="row" style="overflow-x: scroll;">
                                <div class="box-body table_group">
                                    @if($cash_advance->status=='Pending')
                                    ...
                                    <a href="{{route('payroll.removeCashAdvance',$cash_advance->id)}}" class="btn btn-danger pull-right btn-xs"><i class="fa fa-close"> Delete</i></a>
                                    @endif
                                </div>
                                <div class="box-body table_group">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('payroll.payroll.viewReport',$row['payments_id'])}}" target="_blank">View Report</a>
                                            @endif
                                            @endif
                                        </td>
