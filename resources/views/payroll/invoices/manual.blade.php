    ...
    <section id="Invoice">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <h3 class="bold">Invoices - Needs Finalized (Manual)</h3>
                    </div>
                    ...
                    <div class="box-body table_group" style="overflow-x:scroll">
                        ...
                        <tr class="line">
                            <td><button class="btn btn-success btn-xs btn-send-{{$invoice->id}}" data-toggle="modal" data-target="#modal-send-{{$invoice->id}}" ><i class="fa fa-check">&nbsp;&nbsp; Yes</i></button>
                                @component('payroll.invoices.components.finalized_modal')
                                @slot('id') 
                                    {{ $invoice->id }}
                                @endslot
                                @slot('from') 
                            ...
                            <td>
                                <a href="/payrollManager/editInvoice/{{$invoice->id}}?from=manual" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                <?php
                $clients=\App\Clients::where('status','active')->where('invoice_method','manual')->get();
