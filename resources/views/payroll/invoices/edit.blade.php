...
@section('content')
    <section id="editInvoice">
        <div class="row">
            ...
            @endif
            {!! Form::open(['route' => 'payroll.invoices.update','autocomplete' => 'off']) !!}
            <input type="hidden" name="from" value="{{$from}}">
            <input type="hidden" name="invoice_id" value="{{$invoice->id}}">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="bold">Edit Invoice</h3>
                <a href="{{route('payroll.invoices.'.$from)}}" class="btn btn-danger pull-right" type="button" style="margin-left: 5px">Back</a>
