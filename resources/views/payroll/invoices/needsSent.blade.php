    ...
    <section id="Invoice">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <h3 class="bold">Invoices - Needs Sent</h3>
                    </div>
                    <a href="{{route('payroll.adjustment.create')}}" class="btn btn-warning pull-right"><i class="fa fa-refresh">&nbsp;&nbsp; To Adjustment</i></a>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                <div class="col-xs-12" style="padding: 10px 0px 40px 0px">
                    <div class="box-body table_group" style="overflow-x:scroll">
                        ...
                        <tr class="line">
                            <td><button class="btn btn-success btn-xs btn-send-{{$invoice->id}}" data-toggle="modal" data-target="#modal-send-{{$invoice->id}}" ><i class="fa fa-check">&nbsp;&nbsp; Sent</i></button>
                                @component('payroll.invoices.components.send_invoice_modal')
                                @slot('id') 
                                    {{ $invoice->id }}
                                @endslot
                                @endcomponent
                            ...
                            <td>
                                <a href="/payrollManager/editInvoice/{{$invoice->id}}?from=needsSent" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                ...
                ?>
                <p><a href="{{route('payroll.timesheet.pastTimesheets')}}">{{$timecards_Approved}} timesheet(s)</a> approved and <a href="{{route('payroll.timesheet.pendingWorkerApproval')}}">{{$timecards_not}} timesheet(s)</a> awaiting approval for client [{{$client->client_name}}] at {{date('m/d/Y',strtotime($timecard->end_date))}}.</p>
                <?php
                }}}
                ?>
            </div>
