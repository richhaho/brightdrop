                    ...
                    <div class="box-body table_group" style="overflow-x:scroll">
                        ...
                        <tr class="line">
                            <td><button class="btn btn-success btn-xs btn-verify-{{$invoice->id}}" data-toggle="modal" data-target="#modal-verify-{{$invoice->id}}" ><i class="fa fa-check">&nbsp;&nbsp; Verify</i></button>
                                @component('payroll.invoices.components_bank.verifymodal')
                                @slot('id') 
                                    {{ $invoice->id }}
                                @endslot
                                @endcomponent</td>
                            ...
                            <td>
                                <a href="/payrollManager/editInvoice/{{$invoice->id}}?from=bankVerifications" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
