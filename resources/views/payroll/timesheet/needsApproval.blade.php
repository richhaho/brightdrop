    ...
    <section id="NeedsApproval">
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    {!! Form::open(['route' => 'payroll.timesheet.setfilter', 'class'=>'form-inline'])!!}
                        ...
                        &nbsp;&nbsp;<a href="{{ route('payroll.timesheet.resetfilter') }}?page=needsApproval" class="btn btn-danger btn-xs"> <i class="fa fa-times"></i> Clear</a>
                    {!! Form::close() !!}
                    </div>
                </div>
            </div><br>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                ...
                ?>
                {!! Form::open(['route' => 'payroll.timesheet.submitApprove','autocomplete' => 'off']) !!}
                <div class="panel panel-default Worker-{{$timecard->worker()->id}} Timecards">
                    <div class="panel-heading" role="tab" id="heading{{$timecard->id}}">
                        ...
                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse{{$timecard->id}}" aria-expanded="true" aria-controls="collapse{{$timecard->id}}">
                            <h4><i class="fa fa-plus-square"></i> Client: {{$client->client_name}} , Worker: {{$timecard->worker()->fullname}} , Billing Cycle Ending: {{date('m/d/y',strtotime($timecard->end_date))}}</h4>
                        </a>
                        </div>
                            ...
                            <div class="row" style="padding: 10px 0px 40px 0px;overflow-x: scroll;">
                                <div class="box-body table_group">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <a href="#" class="btn btn-danger pull-right"  data-toggle="modal" data-target="#modal-decline-hours-{{$timecard->id}}">Decline</a>
                                              ...
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                        <a href="{{route('payroll.timesheet.declineTimecard')}}?id={{$timecard->id}}" class="btn btn-danger">Decline</a>&nbsp;&nbsp;
...
$('.search_clients').change(function () {
    ...
    $.get("{{route('payroll.client.allWorkers')}}",{"clients_id":id, "from": "needs_approval"}).done(function( workers ) {
