...
@section('content')
    <section id="editPayment">
        <div class="row">
            ...
            @endif
            {!! Form::open(['route' => 'payroll.payment.update','autocomplete' => 'off']) !!}
            <input type="hidden" name="from" value="{{$from}}">
            <input type="hidden" name="payment_id" value="{{$payment->id}}">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="bold">Edit Payment</h3>
                <a href="{{route('payroll.payroll.'.$from)}}" class="btn btn-danger pull-right" type="button" style="margin-left: 5px">Back</a>
