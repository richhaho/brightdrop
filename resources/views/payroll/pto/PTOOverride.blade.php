    ...
    <section id="PTO">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <h3 class="bold">Create PTO Request</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                ...
                <div class="col-xs-12">
                    {!! Form::open(['route' => 'payroll.submitPTO','autocomplete' => 'off']) !!}
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input name="date_pto" type="date" class="form-control date_pto"  data-date-autoclose="true" data-date-format ="mm/dd/yy" data-toggle="tooltip" data-placement="top" title="" required>
                                </div>
                                <div class="col-md-4 form-group">
                               ...
                               <div class="col-md-8 form-group">
                                    <label>Reason:</label>
                                    <input name="reason" type="text" value="" class="form-control reason">
                                </div>
...
$('.btn_first_submit').click(function(){
    ...
    $.get("{{route('payroll.exist_pto')}}",{"client_id":client_id,"worker_id":worker_id,"date":date}).done(function( data ) {
        if(data.id>0){
