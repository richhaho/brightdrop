        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        {!! Form::open(['route' => 'payroll.pto.setfilter', 'class'=>'form-inline'])!!}
                            ...
                            <span>&nbsp; Status:</span>
                             {!!  Form::select('status',[''=> '', 'active' => 'Active', 'inactive' => 'Inactive'], $status, ['class' => 'search_status','style'=>'margin-left:2px;width:80px']) !!}
                            <span>&nbsp; Year:</span>
                            ...
                            &nbsp;&nbsp;<a href="{{ route('payroll.pto.resetfilter') }}?page=PTOsummary" class="btn btn-danger btn-xs"> <i class="fa fa-times"></i> Clear</a>
                        {!! Form::close() !!}
                        </div>
                    </div>
                </div><br>
                ...
                <div class="Client-{{$pto_summary['client']}} Clients">
                    <div class="panel panel-default Worker-{{$pto_summary['worker']}} Worker">
                        {!! Form::open(['route' => 'payroll.updatePTOsummary','autocomplete' => 'off']) !!}
