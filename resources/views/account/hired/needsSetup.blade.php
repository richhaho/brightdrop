                ...
                <div class="box-body table_group" style="overflow-x:scroll">
                    <table id="detail_table" class="table table-hover text-center table-bordered">
                        ...
                        <tr>
                            ...
                            <td><input readonly class="form-control client_hourly_rate_usd numeric-field" type="text" min="0" step="0.01" value="{{$hired->client_hourly_rate_usd}}" onfocusout="updateOneField(this, 'client_hourly_rate_usd')"></td>
                            <td><input readonly class="form-control worker_monthly_rate numeric-field" type="text" min="0" step="0.01" value="{{$hired->worker_monthly_rate}}" onfocusout="updateOneField(this, 'worker_monthly_rate')"></td>
                            <td><input readonly class="form-control worker_hourly_rate numeric-field" type="text" min="0" step="0.01" value="{{$hired->worker_hourly_rate}}" onfocusout="updateOneField(this, 'worker_hourly_rate')"></td>
