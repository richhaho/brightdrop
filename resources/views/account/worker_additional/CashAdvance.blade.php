    ...
    <section id="Cash_advance">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <h3 class="bold">Worker -  Cash Advance</h3>
                    </div>
                </div>
            </div>
            ...
            {!! Form::open(['route' => 'account.submitCashAdvance','autocomplete' => 'off']) !!}
                <div class="col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label>Payment Method:</label>
                            {!!  Form::select('currency_type',$currency_type,old("currency_type"), ['class' => 'form-control  currency_type ' ]) !!}
                        </div>
                    </div>
                    <div class="row">    
            ...
            {!! Form::open(['route' => 'account.updateCashAdvance','autocomplete' => 'off']) !!}
                ...
                <div class="col-xs-12 submited_advance">
                    <div class="panel panel-default open_cash_child">
                        ...
                        <div class="panel-body">
                            <div class="col-xs-12">
                                <div class="box-body table_group">
                                    <button type="submit" class="btn btn-success pull-right btn-xs"><i class="fa fa-save"></i> Save</button>
                                    <button type="button" class="btn btn-warning pull-right btn-xs" onclick="edit_table(this);" data="{{$cash_advance->id}}"><i class="fa fa-edit"></i> Edit</button>
                                    <a href="{{route('account.removeCashAdvance',$cash_advance->id)}}" class="btn btn-danger pull-right btn-xs"><i class="fa fa-close"> Delete</i></a>
                                </div>
                                <div class="box-body table_group">
                                    <table id="detail_table" class="table table-hover text-center table-bordered">
                                    <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="currency[{{$row['payment_number']}}]" type="text" class="form-control currency" value="{{$row['currency']}}" readonly></td>
                                ...
                                <div class="box-body table_group"> 
                                    <div class="col-xs-8">
                                        ...
                                        <div class="col-xs-3">
                                            <label class="total_paid"><input type="text" name="total_paid" class="form-control" style="margin-top: -5px"  onchange="submited_calculate_total(this);" data="{{$cash_advance->id}}" value="{{$cash_advance->total_paid}}"></label>
                                        </div>
                                        <div class="col-xs-3">
                                            <label>PHP</label>
                                        </div>
