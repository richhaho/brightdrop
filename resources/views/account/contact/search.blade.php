    ...
    <section id="contactSearch">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                {!! Form::open(['route' => 'account.contact.setfilter','autocomplete' => 'off']) !!}
                <div class="col-xs-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group"  >
                                    ...
                                    <a href="{{route('account.contact.resetfilter')}}" class="btn btn-warning pull-right"><i class="fa fa-remove"></i> Clear</a>
                                ...
                                <div class="box-body table_group">
                                    <table id="list_table" class="table table-hover text-center table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$contact->state}} </td>
                                            <td>
                                                <a href="/accountManager/profileContact/{{$contact->id}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                                                <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-close"  data-toggle="modal" data-target="#modal-delete-{{$contact->id}}"></i></a>
                                                @component('account.contact.components.deletemodal')
                                                @slot('id') 
                                                    {{ $contact->id }}
                                                @endslot
                                                @endcomponent
