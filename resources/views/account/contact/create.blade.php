...
{!! Form::open(['route' => 'account.contact.store','autocomplete' => 'off']) !!}
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12" >
                        <h3 class="bold">Create New Contact</h3>
                    </div>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1"><i class="fa fa-minus-square"></i> Contact Status</a></div>
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse3"><br>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    {!!  Form::select('same_as_client',$same_as_client,old("same_as_client"), ['class' => 'form-control same_as_client' ]) !!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label>Country:</label>
                                    {!!  Form::select('country',$country,old("country"), ['class' => 'form-control changeCountry mailing_address','onchange'=>'changeCountry()' ]) !!}
                                </div>
                            </div>
                            <div class="row changeCountryOther" style="display: none">
                                <div class="col-md-6 form-group">
                                    <label>Country - Other:</label>
                                    <input name="country_other" class="form-control mailing_address" type="text" value="">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label> Full Address - Foreign:</label>
                                    <input name="full_address_other" class="form-control mailing_address" type="text" value="">
                                </div>
                            </div>
                            <div class="row changeCountryUS">
                                <div class="col-md-6 form-group">
                                    <label>Address Line 1:</label>
                                    <input name="address1" class="form-control mailing_address" type="text" value="">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Address Line 2:</label>
                                    <input name="address2" class="form-control mailing_address" type="text" value="">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>City:</label>
                                    <input name="city" class="form-control mailing_address" type="text" value="">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>State:</label>
                                    <input name="state" class="form-control mailing_address " type="text" value="">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Zip Code:</label>
                                    <input name="zip" class="form-control mailing_address" type="text" value="">
                                </div>
                            </div><br>
                        </div>
                    </div>
