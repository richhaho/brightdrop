    ...
    <section id="NeedsApproval">
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    {!! Form::open(['route' => 'account.timesheet.setfilter', 'class'=>'form-inline'])!!}
                        ...
                        &nbsp;&nbsp;<a href="{{ route('account.timesheet.resetfilter') }}?page=currentTimesheets" class="btn btn-danger btn-xs"> <i class="fa fa-times"></i> Clear</a>
                    {!! Form::close() !!}
                    </div>
                </div>
            </div><br>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                ...
                ?>
                @if($client && $worker)
                {!! Form::open(['route' => 'account.timesheet.submitCurrent','autocomplete' => 'off']) !!}
