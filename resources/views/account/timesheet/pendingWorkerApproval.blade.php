    ...
    <section id="NeedsApproval">
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="hidden" name="page" value="pendingWorkerApproval">
                        ...
                        &nbsp;&nbsp;<a href="{{ route('account.timesheet.resetfilter') }}?page=pendingWorkerApproval" class="btn btn-danger btn-xs"> <i class="fa fa-times"></i> Clear</a>
                    {!! Form::close() !!}
                    </div>
                </div>
            </div><br>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                ...
                @endif
                {!! Form::open(['route' => 'account.timesheet.submitPendingWorkerApproval','autocomplete' => 'off']) !!}
...
$('.search_clients').change(function () {
    ...
    $.get("{{route('account.client.allWorkers')}}",{"clients_id":id, "from": "pending_worker"}).done(function( workers ) {
