...
{!! Form::open(['route' => ['account.position.update', $position->id],'autocomplete' => 'off']) !!}
<section id="CreatePosition">
    <div class="row" style="margin-bottom: 20px">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12" >
                <a href="{{route('account.position.create')}}" class="btn btn-primary"> Create New Position</a>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" >
                <button type="submit" class="btn btn-success btn-save pull-right"  {{$from ? '' : 'disabled'}}><i class="fa fa-save"></i> Save Position</button>
                <button type="button" class="btn btn-warning btn-edit pull-right"><i class="fa fa-save"></i> Edit Position</button>
            </div>
        </div>
    </div>
    <div class="row disable-group main-section">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            {!!  Form::select('clients_id', $client_list, $position->clients_id, ['class' => 'form-control', 'required'=>true]) !!}
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            <label>Status:</label>
                            {!!  Form::select('status', $status, $position->status, ['class' => 'form-control position-status']) !!}
                        </div>
                   
                        <div class="col-md-6 form-group">
                            <label>Visible to Client:</label>
                            {!!  Form::select('visible_to_client', $visible_to_client, $position->visible_to_client, ['class' => 'form-control', 'required'=>true]) !!}
                        </div>
                        <input type="hidden" name="editable_to_client" value="yes">
                    </div>
                </div>    
            </div>
        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="box-body table_group">
                        ...
                        <tr>
                            <td><input name="group_id[{{$group['id']}}]" type="hidden" value="{{$group['id']}}"><input name="group_name[{{$group['id']}}]" type="text" class="form-control" value="{{$group['name']}}" required {{$group['can_delete'] ? '' : 'readonly'}}></td>
                ...
                <div class="panel-body">
                    <div class="box-body table_group">
                        ...
                        <tr>
                            ...
                            <td><input name="column_visible_to_brightdrop[{{$column['id']}}]" type="checkbox" class="btn" {{$column['visible_to_brightdrop'] ? 'checked' : ''}} style="{{$column['can_visible_to_brightdrop'] ? '' : 'pointer-events:none;opacity: 0.3;outline: 2px solid red'}}"></td>
                            <td><input name="column_visible_to_client[{{$column['id']}}]" type="checkbox" class="btn" {{$column['visible_to_client'] ? 'checked' : ''}} style="{{$column['can_visible_to_client'] ? '' : 'pointer-events:none;opacity: 0.3;outline: 2px solid red'}}"></td>
                            <td><input name="column_editable_to_client[{{$column['id']}}]" type="checkbox" class="btn" {{$column['editable_to_client'] ? 'checked' : ''}} style="{{$column['can_editable_to_client'] ? '' : 'pointer-events:none;opacity: 0.3;outline: 2px solid red'}}"></td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                                <div class="col-xs-12 form-group">
                                    ...
                                    {!!  Form::select('update_field_types', $field_types, 'text', ['class' => 'form-control update_field_type']) !!}
                                </div>
...
$(function () {
    ...
    $('.btn-edit').click(function() {
        $('.main-section').removeClass('disable-group');
    ...
    $('.btn-reject-active').click(function() {
        $('.position-status').val('inactive');
    });
});
function add_group() {
    let d = Date.now();
    let newgroup= '<tr>'
                ...
                +    '<td><input name="group_visible_to_brightdrop['+d+']" type="checkbox" checked class="btn"></td>'
...
function add_column() {
    ...
    let newcolumn='<tr>'
                ...
                +    '<td><input name="column_visible_to_brightdrop['+d+']" type="checkbox" checked class="btn"></td>'
                ...
                +    '<input type="hidden" name="field_type['+d+']" value="text" class="field_type">'
