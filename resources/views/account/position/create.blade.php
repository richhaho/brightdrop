...
{!! Form::open(['route' => 'account.position.store','autocomplete' => 'off']) !!}
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="box-body table_group">
                        ...
                        <tr>
                            <td><input name="group_name[{{$group['id']}}]" type="text" class="form-control" value="{{$group['name']}}" required {{$group['can_delete'] ? '' : 'readonly'}}></td>
