    ...
    <section id="PayrollImmediatePay">
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                    {!! Form::open(['route' => 'admin.payroll.setfilter', 'class'=>'form-inline'])!!}
                        ...
                        &nbsp;&nbsp;<a href="{{ route('admin.payroll.resetfilter') }}?page=viewClosed" class="btn btn-danger btn-xs"> <i class="fa fa-times"></i> Clear</a>
                    {!! Form::close() !!}
                    </div>
                </div>
            </div><br>
                ...
                <div class="row" style="padding: 10px 0px 40px 0px">
                    <div class="box-body table_group" style="overflow-x:scroll">
                        ...
                        <tr class="payment_{{$payment->id}}">
                            ...
                            <td>
                                <a href="/admin/editPayment/{{$payment->id}}?from=viewClosed" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
...
$('.search_clients').change(function () {
    ...
    $.get("{{route('admin.client.activeWorkers')}}",{"clients_id":id}).done(function( workers ) {
