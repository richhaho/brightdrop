...
{!! Form::open(['route' => 'admin.payroll.update','autocomplete' => 'off']) !!}
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12" >
                        <h3 class="bold">Payroll Manager: {{$payroll->fullname}}'s Profile</h3>
                    </div>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12 main_content">
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1"><i class="fa fa-minus-square"></i> Payroll Manager Status</a></div>
                        <div class="panel-body panel-collapse collapse in" id="collapse1"><br>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label>Payroll Manager:</label>
                                    {!!  Form::select('status',$status,$payroll->status, ['class' => 'form-control' ]) !!} 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse2"><br>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="first_name" class="form-control " type="text" value="{{$payroll->first_name}}" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Last Name:</label>
                                    <input name="last_name" class="form-control " type="text" value="{{$payroll->last_name}}" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Email:</label>
                                    <input name="email" class="form-control email" type="email" value="{{$payroll->email}}" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Phone Number:</label>
                                    <input name="phone" class="form-control " type="text" value="{{$payroll->phone}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse3"><br>
                            ...
                            <div class="row changeCountryUS">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="address1" class="form-control " type="text" value="{{$payroll->address1}}" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Address Line 2:</label>
                                    <input name="address2" class="form-control " type="text" value="{{$payroll->address2}}">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>City:</label>
                                    <input name="city" class="form-control " type="text" value="{{ $payroll->city}}" required>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>State:</label>
                                    <input name="state" class="form-control " type="text" value="{{$payroll->state}}" required>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Zip Code:</label>
                                    <input name="zip" class="form-control " type="text" value="{{$payroll->zip}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse4"><br>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="user_email" class="form-control user_email" type="email" value="{{$payroll->user()->email}}" required>
                                </div>
                                <div class="col-md-6 form-group" style="pointer-events:initial;opacity: 1;">
                                    <label>Password:</label><br>
                                    <a href="{{route('admin.payroll.resetpassword')}}?id={{$payroll->id}}" class="btn btn-default"><i class="fa fa-lock"></i> Send Password Reset Link</a>
                                </div>
                            </div>
                        </div>
                    </div>
