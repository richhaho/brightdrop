  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Remove Payroll Manager</h4>
      </div>
      <div class="modal-body">
          <p>Are you sure you want to remove this Payroll Manager?</p>
      </div>
      <div class="modal-footer">
            {!! Form::open(['route' => 'admin.payroll.remove','autocomplete' => 'off']) !!}
