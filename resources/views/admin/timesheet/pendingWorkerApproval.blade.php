        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <h3 class="bold">Timesheet - Pending Worker Approval</h3>
                        <br>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    {!! Form::open(['route' => 'admin.timesheet.setfilter', 'class'=>'form-inline'])!!}
                        <input type="hidden" name="page" value="pendingWorkerApproval">
                        <span>&nbsp; Client:&nbsp;&nbsp;&nbsp;</span>
                        ...
                        &nbsp;&nbsp;<a href="{{ route('admin.timesheet.resetfilter') }}?page=pendingWorkerApproval" class="btn btn-danger btn-xs"> <i class="fa fa-times"></i> Clear</a>
                    {!! Form::close() !!}
                    </div>
                </div>
            </div><br>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                ...
                @endif
                {!! Form::open(['route' => 'admin.timesheet.submitPendingWorkerApproval','autocomplete' => 'off']) !!}
                            ...
                            <div class="row" style="padding: 10px 0px 40px 0px;overflow-x: scroll;">
                                <div class="box-body table_group">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <a href="#" class="btn btn-danger pull-right"  data-toggle="modal" data-target="#modal-decline-hours-{{$timecard->id}}">Delete</a>
                                              ...
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                        <a href="{{route('admin.timesheet.removeTimecard')}}?id={{$timecard->id}}&page=pending_worker" class="btn btn-danger">Delete</a>&nbsp;&nbsp;
                                                        <button class="btn btn-warning" type="button"  data-dismiss="modal"><i calss="fa fa-times"></i> Cancel</button>
                                                  </div>
                                                </div><!-- /.modal-content -->
                                              </div><!-- /.modal-dialog -->
                                            </div>
                                            <a href="#" class="btn btn-success" data-toggle="modal" data-target="#modal-approve-hours-{{$timecard->id}}"><i class="fa fa-check"></i> Approve</a>
...
$('.search_clients').change(function () {
    ...
    $.get("{{route('admin.client.allWorkers')}}",{"clients_id":id, "from": "pending_worker"}).done(function( workers ) {
