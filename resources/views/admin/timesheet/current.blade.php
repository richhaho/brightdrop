    ...
    <section id="NeedsApproval">
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    {!! Form::open(['route' => 'admin.timesheet.setfilter', 'class'=>'form-inline'])!!}
                        ...
                        &nbsp;&nbsp;<a href="{{ route('admin.timesheet.resetfilter') }}?page=currentTimesheets" class="btn btn-danger btn-xs"> <i class="fa fa-times"></i> Clear</a>
                    {!! Form::close() !!}
                    </div>
                </div>
            </div><br>
            ...
            @foreach($timecards as $timecard)
                ...
                ?>
                @if($client && $worker)
                {!! Form::open(['route' => 'admin.timesheet.submitCurrent','autocomplete' => 'off']) !!}
...
$('input').change(function(){
    ...
    for (i=0;i<16;i++){
        if (!$(client_class+' .work_time_hours'+i)) continue;
        var work_time_hours=(parseInt($(client_class+' .work_time_hours'+i).val()) || 0)*60+(parseInt($(client_class+' .work_time_minutes'+i).val()) || 0);
