    ...
    <section id="NeedsApproval">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <h3 class="bold">Timesheet - Needs Approval</h3>
                        <br>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                    {!! Form::open(['route' => 'admin.timesheet.setfilter', 'class'=>'form-inline'])!!}
                        <input type="hidden" name="page" value="needsApproval">
                        <span>&nbsp; Client:&nbsp;&nbsp;&nbsp;</span>
                        ...
                        &nbsp;&nbsp;<a href="{{ route('admin.timesheet.resetfilter') }}?page=needsApproval" class="btn btn-danger btn-xs"> <i class="fa fa-times"></i> Clear</a>
                    {!! Form::close() !!}
                    </div>
                </div>
            </div><br>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                ...
                ?>
                @if ($client_key != $timecard->clients_id)
                <br>
                <h4>- Client: {{$client->client_name}}</h4>
                <?php $client_key = $timecard->clients_id; ?>
                @endif
                {!! Form::open(['route' => 'admin.timesheet.submitApprove','autocomplete' => 'off']) !!}
                        ...
                        <div id="collapse{{$timecard->id}}" class="panel-collapse collapse out" role="tabpanel" aria-labelledby="heading{{$timecard->id}}">    
                            ...
                            <div class="row" style="padding: 10px 0px 40px 0px;overflow-x: scroll;">
                                <div class="box-body table_group">
                                    ...
                                    <tr>
                                       <td colspan=7>
                                            <a href="#" class="btn btn-danger pull-right"  data-toggle="modal" data-target="#modal-delete-hours-{{$timecard->id}}">Delete</a>
                                            <div class="modal fade" id="modal-delete-hours-{{$timecard->id}}" tabindex="-1" role="dialog">
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                        <a href="{{route('admin.timesheet.removeTimecard')}}?id={{$timecard->id}}&page=needs_approval" class="btn btn-danger">Delete</a>&nbsp;&nbsp;
                                                        <button class="btn btn-warning" type="button"  data-dismiss="modal"><i calss="fa fa-times"></i> Cancel</button>
                                                  </div>
                                                </div><!-- /.modal-content -->
                                              </div><!-- /.modal-dialog -->
                                            </div>
                                            <a href="#" class="btn btn-warning pull-right"  data-toggle="modal" data-target="#modal-decline-hours-{{$timecard->id}}">Decline</a>
                                            <div class="modal fade" id="modal-decline-hours-{{$timecard->id}}" tabindex="-1" role="dialog">
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    <h4 class="modal-title">Decline Timesheet</h4>
                                                  </div>
                                                  <div class="modal-body">
                                                      <p>Are you sure you want to decline timesheet?</p>
                                                  </div>
                                                  <div class="modal-footer">
                                                        <a href="{{route('admin.timesheet.declineTimecard')}}?id={{$timecard->id}}" class="btn btn-danger">Decline</a>&nbsp;&nbsp;
                                                        <button class="btn btn-warning" type="button"  data-dismiss="modal"><i calss="fa fa-times"></i> Cancel</button>
                                                  </div>
                                                </div><!-- /.modal-content -->
                                              </div><!-- /.modal-dialog -->
                                            ...
                                            <a href="#" class="btn btn-success pull-right" data-toggle="modal" data-target="#modal-approve-hours-{{$timecard->id}}"><i class="fa fa-check"></i> Approve</a>
                                            <div class="modal fade" id="modal-approve-hours-{{$timecard->id}}" tabindex="-1" role="dialog">
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success btn-submit-approve"> Approve</button>&nbsp;&nbsp;
...
$('.search_clients').change(function () {
    ...
    $.get("{{route('admin.client.allWorkers')}}",{"clients_id":id, "from": "needs_approval"}).done(function( workers ) {
...
//     if (error_count>0) {
//         var id=timecard_tbody.split('_')[1];
//         event.preventDefault();
//         $('#modal-approve-hours-'+id).modal('hide');
//     }
// });
