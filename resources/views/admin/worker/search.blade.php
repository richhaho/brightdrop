    ...
    <section id="WorkerSearch">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                {!! Form::open(['route' => 'admin.worker.setfilter','autocomplete' => 'off']) !!}
                <div class="col-xs-12">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group" style="margin-top:30px">
                                    ...
                                    <a href="{{route('admin.worker.resetfilter')}}" class="btn btn-warning pull-right"><i class="fa fa-remove"></i> Clear</a>
                                </div>
                            </div>
                        </div>
                    </div>
