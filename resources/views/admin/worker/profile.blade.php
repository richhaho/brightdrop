...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
    ...
    ?> 
    @component('admin.worker.components.emailmodal')
    @slot('id') 
        {{ $worker->id }}
    @endslot
    @slot('client_emails') 
...
{!! Form::open(['route' => 'admin.worker.update','autocomplete' => 'off','class'=>'submitform','files'=>true]) !!}
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse21"><br>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    @if($worker->ica)
                                    <a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$worker->ica}}"><i class="fa fa-download"></i> Download File</a>
                                    @endif
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$worker->typing_test_file}}"><i class="fa fa-download"></i> Download File</a>
                                    @endif
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <table id="other_file_table" class="table text-center table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$odf['path'].$odf['filename']}}"><i class="fa fa-download"></i> {{$odf['filename']}}</a></td>
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse3"><br>
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group" style="pointer-events:initial;opacity: 1;">
                                    ...
                                    <a href="{{route('admin.worker.resetpassword')}}?id={{$worker->id}}" class="btn btn-default"><i class="fa fa-lock"></i> Send Reset Link to Worker</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse5"><br>
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group clickable" style="pointer-events:initial;opacity: 1;">
                                    <label>Video Link:</label><br>
                                    @if ($worker->video_link)
                                    <a href="{{$worker->video_link}}" target="_blank">
                                        {{$worker->video_link}}
                                    </a>
                                    @else
                            ...
                            <div class="row">     
                                <div class="col-md-6 form-group red-field">
                                    ...
                                    <a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$worker->video_file}}&type=workers_video" class="clickable"><i class="fa fa-download"></i> Download Video</a>
                                    @endif
                                </div>
                                <div class="col-md-6 form-group red-field">
                                    <label>Resume:</label>
                                    ...
                                    <a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$worker->resume_file}}"><i class="fa fa-download"></i> Download File</a>
                                    @endif
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse6"><br>
                            <div class="row">
                                <div class="col-md-6 form-group red-field">
                                    ...
                                    <a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$worker->goverment_id}}"><i class="fa fa-download"></i> Download File</a>
                                    @endif
                                </div>
                                <div class="col-md-6 form-group blue-field">
                                    ...
                                    @if($worker->NBI)
                                    <a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$worker->NBI}}"><i class="fa fa-download"></i> Download File</a>
                                    @endif
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse11"><br>
                            ...
                            <div class="row yellow-field">
                                ...
                                <div class="col-md-6 form-group ">
                                    ...
                                    <a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$worker->internet_connection_primary_screenshot}}"><i class="fa fa-download"></i> Download File</a>
                                    @endif
                                </div>
                                <div class="col-md-6 form-group ">
                            ...
                            <div class="row yellow-field add-backup-connection" style="{{$style}}">
                                ...
                                <div class="col-md-6 form-group ">
                                    ...
                                    <a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.download')}}?id={{$worker->id}}&filename={{$worker->backup_connection_screenshot}}"><i class="fa fa-download"></i> Download File</a>
                                    @endif
                                </div>
                                <div class="col-md-6 form-group ">
                                    <label>Data Cap:</label>
                            ...
                            <div class="row">
                                <div class="box-body table_group">
                                    ...
                                    <tr>
                                        ...
                                        <td><a style="pointer-events:initial;opacity: 1;" href="{{route('admin.worker.downloadpdf',$payment->id)}}">Download Payment Summary</a></td>
