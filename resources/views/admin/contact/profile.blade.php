...
{!! Form::open(['route' => 'admin.contact.update','autocomplete' => 'off']) !!}
                        ...
                        <div class="panel-body panel-collapse collapse out" id="collapse4"><br>
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group" style="pointer-events:initial;opacity: 1;">
                                    ...
                                    <a href="{{route('admin.contact.resetpassword')}}?id={{$contact->id}}" class="btn btn-default"><i class="fa fa-lock"></i> Send Password Reset Link</a>
                                </div>
                            </div>
                        </div>
                    </div>
