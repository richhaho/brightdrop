                                                    ...
                                                    <tbody class="tbody-candidates table-dragable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                {!!  Form::select('candidate_name', $workerList, $value, ['class' => 'form-control name candidate_name', 'disabled'=>true]) !!}
                                                                ...
                                                                <a type="hyperlink" class="btn {{$column['field']}}" href="{{str_replace('accountManager', 'admin',str_replace('www.', '', $value))}}" target="_blank">Click Here</a>
