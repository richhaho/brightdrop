...
@endsection
@section('content')
<section id="HiredNeedsFinalized">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3 class="bold">Hired - Needs Finalized</h3>
        </div>
                ...
                <div class="box-body table_group" style="overflow-x:scroll">
                    <table id="detail_table" class="table table-hover text-center table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{$hired->email}}</td>
                            <td>{!!  Form::select('rehire', ['yes'=>'Yes', 'no'=>'No'], $hired->rehire, ['class' => 'form-control rehire', 'onchange'=>'updateOneField(this, "rehire")']) !!}</td>
                            <td>{!!  Form::select('available_additional_work', [''=>'', 'yes'=>'Yes', 'no'=>'No'], $hired->available_additional_work, ['class' => 'form-control available_additional_work', 'onchange'=>'updateOneField(this, "available_additional_work")']) !!}</td>
                            <td><input class="form-control client_hourly_rate_usd numeric-field" type="text" min="0" step="0.01" value="{{$hired->client_hourly_rate_usd}}" onfocusout="updateOneField(this, 'client_hourly_rate_usd')"></td>
                            <td>{{$hired->requested_pay}}</td>
                            <td><input class="form-control worker_monthly_rate numeric-field" type="text" min="0" step="0.01" value="{{$hired->worker_monthly_rate}}" onfocusout="updateOneField(this, 'worker_monthly_rate')"></td>
                            <td><input class="form-control worker_hourly_rate numeric-field" type="text" min="0" step="0.01" value="{{$hired->worker_hourly_rate}}" onfocusout="updateOneField(this, 'worker_hourly_rate')"></td>
                            <td>{{$hired->worker_currency_type}}</td>
                            <td>{!!  Form::select('pto', [''=>'', 'yes'=>'Yes', 'no'=>'No'], $hired->pto, ['class' => 'form-control pto', 'onchange'=>'updateOneField(this, "pto")']) !!}</td>
                            <td>{!!  Form::select('paid_holidays', [''=>'', 'yes'=>'Yes', 'no'=>'No'], $hired->paid_holidays, ['class' => 'form-control paid_holidays', 'onchange'=>'updateOneField(this, "paid_holidays")']) !!}</td>
                            <td><input class="form-control expected_start_date" type="date" value="{{$hired->expected_start_date}}" onchange="updateOneField(this, 'expected_start_date')"></td>
...
function addHired() {
    const row = `<tr>
                    ...
                    <td><input class="form-control client_hourly_rate_usd numeric-field" type="text" min="0" step="0.01" value="" onfocusout="updateOneField(this, 'client_hourly_rate_usd')"></td>
                    <td><input class="form-control requested_pay" readonly type="text"></td>
                    <td><input class="form-control worker_monthly_rate numeric-field" type="text" min="0" step="0.01" value="" onfocusout="updateOneField(this, 'worker_monthly_rate')"></td>
                    <td><input class="form-control worker_hourly_rate numeric-field" type="text" min="0" step="0.01" value="" onfocusout="updateOneField(this, 'worker_hourly_rate')"></td>
...
function finalize() {
    ...
    $.ajax({
        ...
        type: "post",
        data: {hired_id: hired_id, status: 'Pending Review'},
        success: function(response) {
            if (response=='OK') {
