    ...
    <section id="CreateAdjustment">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <h3 class="bold">Past Adjustments</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><center>Past Adjustments - One-Time</center></div>
                        ...
                        <div class="panel-body" style="overflow-x:scroll">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @component('admin.adjustment.components.deletemodal')
                                    @slot('id')
                                        {{ $adjustment->id }}
                                    @endslot
                                    @slot('to')
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default open_cash_child">
                        <div class="panel-heading"><center>Past Adjustments - Recurring</center></div>
                        <div class="panel-body col-xs-12">
