                    ...
                    <div class="box-body table_group" style="overflow-x:scroll">
                        ...
                        <tr class="line">
                            <td><button class="btn btn-success btn-xs btn-process-{{$invoice->id}}" data-toggle="modal" data-target="#modal-process-{{$invoice->id}}" ><i class="fa fa-check">&nbsp;&nbsp; Yes</i></button>
                                @component('admin.invoices.components_process.processmodal')
                                @slot('id') 
                                    {{ $invoice->id }}
                                @endslot
                                @endcomponent</td>
                            ...
                            <td>
                                <a href="/admin/editInvoice/{{$invoice->id}}?from=needsProcessed" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
