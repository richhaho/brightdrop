                    ...
                    <div class="box-body table_group" style="overflow-x:scroll">
                        ...
                        <tr class="line">
                            <td><button class="btn btn-success btn-xs btn-approve-{{$invoice->id}}" data-toggle="modal" data-target="#modal-approve-{{$invoice->id}}" ><i class="fa fa-check">&nbsp;&nbsp; Approve</i></button>
                                @component('admin.invoices.components_pending.approvemodal')
                                @slot('id') 
                                    {{ $invoice->id }}
                                @endslot
                                @endcomponent</td>
                            ...
                            <td>
                                <a href="/admin/editInvoice/{{$invoice->id}}?from=pendingClientApproval" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
