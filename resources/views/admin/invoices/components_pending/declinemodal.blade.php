  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
            {!! Form::open(['route' => 'admin.invoices.declinebyclient','autocomplete' => 'off']) !!}
            <input type="hidden" name="id" value="{{$id}}">
            <!-- <a href="{{route('admin.adjustment.create')}}" class="btn btn-success"><i class="fa fa-refresh">&nbsp;&nbsp; To Adjustment</i></a> -->
