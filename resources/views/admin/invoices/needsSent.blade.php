                    ...
                    <div class="box-body table_group" style="overflow-x:scroll">
                        ...
                        <tr class="line">
                            <td><button class="btn btn-success btn-xs btn-send-{{$invoice->id}}" data-toggle="modal" data-target="#modal-send-{{$invoice->id}}" ><i class="fa fa-check">&nbsp;&nbsp; Sent</i></button>
                                @component('admin.invoices.components.send_invoice_modal')
                                @slot('id') 
                                    {{ $invoice->id }}
                                @endslot
                                @endcomponent 
                            ...
                            <td>
                                <a href="/admin/editInvoice/{{$invoice->id}}?from=needsSent" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
