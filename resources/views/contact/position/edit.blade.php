...
{!! Form::open(['route' => ['contact.position.update', $position->id],'autocomplete' => 'off']) !!}
<section id="CreatePosition">
    <div class="row" style="margin-bottom: 20px">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12" >
                <a href="{{route('contact.position.create')}}" class="btn btn-primary"> Create New Position</a>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            @endcomponent
                            @component('contact.position.components.activemodal')
                            @endcomponent
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            {!!  Form::select('editable_to_client', $editable_to_client, $position->editable_to_client, ['class' => 'form-control', 'required'=>true]) !!}
                        </div>
                    </div>
                </div>    
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="box-body table_group">
                        ...
                        <tr>
                            <td><input name="group_id[{{$group['id']}}]" type="hidden" value="{{$group['id']}}"><input name="group_name[{{$group['id']}}]" type="text" class="form-control" value="{{$group['name']}}" required></td>
