...
class PositionController extends Controller
{
    public function create()
    {
        ...
        $client_list=$accountmanager->clients()->orderBy('client_name')->get()->pluck('client_name','id')->prepend('', '')->toArray();
        ...
        return view('account.position.create',$data);
    }
    ...
    { 
        ...
        return redirect()->route('account.position.edit',$position->id);
    ...
    public function edit($id, Request $request)
    {
        ...
        if (count($position)==0){
            ...
            return redirect()->route('account.position.open');
        }
        $position->updated_at=date('Y-m-d H:i:s');
        $position->save();
        $status=[
        ...
        $editable_to_client = $visible_to_client;
        $accountmanager=Auth::user()->accountmanager();
        $client_list=$accountmanager->clients()->where('deleted_at',null)->orderBy('client_name')->get()->pluck('client_name','id')->prepend('', '')->toArray();
        ...
        return view('account.position.edit',$data);
    }
    ...
    public function copy($id)
    {
        ...
        return redirect()->route('account.position.edit', $newPosition->id);
    }
    ...
    public function open()
    {
        ...
        $workers=$accountmanager->candidateWorkers()->whereIn('status', ['new_candidate','pre_candidate','available_hired'])->orderBy('first_name', 'ASC')->get();
        $search_client=$accountmanager->clients()->orderBy('client_name', 'ASC')->get()->pluck('client_name','id')->prepend('All',0);
        $search_account=[
            0 => 'All',
        ...
        return view('account.position.open',$data);
    }
    ...
    public function past()
    {
        ...
        return view('account.position.past',$data);
    }
