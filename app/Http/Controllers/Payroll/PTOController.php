...
class PTOController extends Controller
{
    public function PTOneedsApproval()
    {
        ...
        return view('payroll.pto.PTONeedsApproval',$data);
    ...
    public function approvePTO(Request $request)
    {
        ...
        return redirect()->route('payroll.PTONeedsApproval');
    }
    ...
    public function PTOOverride()
    {
        ...
        return view('payroll.pto.PTOOverride',$data);
    }
    public function PTOpast()
    {
        ...
        return view('payroll.pto.PTOpast',$data);
    }
    ...
    public function setfilter (Request $request) {
        ...
        return redirect()->route('payroll.'.$page);
    }
    ...
    public function PTOsummary()
    {
        ...
        if (!$clients_id || !$workers_id || !$status || !$year) {
            return view('payroll.pto.PTOsummary',$data);
        }
    ...
    public function updatePTOsummary(Request $request)
    {
        ...
        if ($total>$pto_days_worker_default*8 && !$removed) {
            ...
            return redirect()->route('payroll.PTOsummary');
        }
        $unexist_date = array();
        if (isset($request->origin_pto_date)) {
    ...
    public function submitPTO(Request $request)
    {
        ...
        if ($assigned === false) {
            ...
            return redirect()->route('payroll.PTOOverride');
        }
