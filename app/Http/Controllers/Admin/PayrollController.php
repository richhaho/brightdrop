...
{
    function resetHiredAt() {
        /*
          UPDATE `clientinfo_workers` 
          SET clientinfo_workers.created_at = clientinfo_workers.hired_at
        */
        foreach(ClientInfoWorkers::where('hired_at', null)->get() as $info) {
            $info->hired_at = $info->created_at;
            if (substr($info->created_at, 0,4) == '2023') {
                $info->hired_at = date('2022-m-d H:i:s', strtotime($info->created_at));
            }
            $info->save();
        }
    }
    ...
    public function immediateWU()
    {
        ...
        return view('admin.payroll.immediateWU',$data);
    }
    public function immediateVeem()
    {
        ...
        return view('admin.payroll.immediateVeem',$data);
    }
    public function biWeeklyWU()
    {
        ...
        return view('admin.payroll.biWeeklyWU',$data);
    }
    public function biWeeklyVeem()
    {
        ...
        return view('admin.payroll.biWeeklyVeem',$data);
    }
    public function viewClosed()
    {
        ...
        return view('admin.payroll.viewClosed',$data);
    ...
    public function setfilter (Request $request) {
        ...
        return redirect()->route('admin.payroll.'.$page);
    }
    ...
    public function pay(Request $request)
    {
        ...
        if ($payment->payment_method == 'Veem' && !$payment->veem_pay_status) {
            ...
            if ($res != 'success') {
                ...
                return redirect()->route('admin.payroll.'.$request->from);
            }
    ...
    public function remove(Request $request)
    {
        ...
        return redirect()->route('admin.payroll.'.$from);
    }
    ...
    public function update(Request $request)
    {
        ...
        if (count($lines)==0) {
            ...
            return redirect()->route('admin.payment.edit', ['id'=>$payment->id,'from'=>$from]);
        }
