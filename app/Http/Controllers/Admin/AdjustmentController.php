...
class AdjustmentController extends Controller
{
    public function needsApproval()
    {
        ...
        return view('admin.adjustment.needsApproval',$data);
    }
    ...
    public function approve_adjustmentOneTime(Request $request)
    {
        ...
        $adjustment->payroll_managers_id=0;//Auth::user()->payrollmanager()->id;
        $adjustment->save();
        ...
        return redirect()->route('admin.adjustment.needsApproval');
    }
    ...
    { 
        ...
        $adjustment->handle_date=date('Y-m-d',strtotime(Carbon::now()));
        $adjustment->payroll_managers_id=0;
        $adjustment->save();
        if ($adjustment->type=='Internet - Backup' || $adjustment->type=='Internet - Primary'){
            $reimbursement=$adjustment->reimbursement();
            $mailto=$reimbursement->worker()->email_main;
...
//////////////////////////////////////////////////////////////
    ...
    public function create()
    {
        ...
        return view('admin.adjustment.create',$data);
    }
    ...
    public function active()
    {
        ...
        return view('admin.adjustment.active',$data);
    }
    public function past()
    {
        ...
        return view('admin.adjustment.past',$data);
    }
    public function pending()
    {
        ...
        return view('admin.adjustment.pending',$data);
    }
    public function submit_onetime(Request $request)
    {
        ...
        if ($data['payto']==$data['billto']){
            ...
            return redirect()->route('admin.adjustment.create');
        }
    ...
    public function remove_onetime(Request $request)
    {
        ...
        // if ($adjustment->status == 'Approved' && ($adjustment->payments_id || $adjustment->invoices_id)) {
        //     Session::flash('message', "The One time adjustment can not be deleted because its in payment or invoice summary but still not paid.");
        //     return redirect()->route('admin.adjustment.'.$from);    
        // } else if ($adjustment->status == 'Paid' && !$adjustment->invoices_id) {
        //     Session::flash('message', "The One time adjustment can not be deleted because it was paid but invoice was not generated.");
        //     return redirect()->route('admin.adjustment.'.$from);    
        // } 
        // else if ($adjustment->status == 'Paid' && $adjustment->payments_id && $adjustment->invoices_id) {
        //     $payment = $adjustment->payment();
        //     if ($payment->payment_type != 'bi-weekly' || $payment->status != 'Paid') {
        //         Session::flash('message', "The One time adjustment can not be deleted because it was not paid on bi-weekly payment summary.");
        //         return redirect()->route('admin.adjustment.'.$from);    
        //     }
        // }
    ...
    public function update_onetime(Request $request)
    {
        ...
        return redirect()->route('admin.adjustment.'.$data['from']);
    }
