...
class InvoiceController extends Controller
{
    public function manual()
    {
        ...
        return view('admin.invoices.manual',$data);
    }
    public function automatic()
    {
        ...
        return view('admin.invoices.automatic',$data);
    }
    public function needsSent()
    {
        ...
        return view('admin.invoices.needsSent',$data);
    }
    public function pendingClientApproval()
    {
        ...
        return view('admin.invoices.pendingClientApproval',$data);
    }
    public function needsProcessed()
    {
        ...
        return view('admin.invoices.needsProcessed',$data);
    }
    public function bankVerifications()
    {
        ...
        return view('admin.invoices.bankVerifications',$data);
    }
    public function viewClosed()
    {
        ...
        return view('admin.invoices.viewClosed',$data);
    }
    public function finalized(Request $request)
    {
        ...
        if ($invoice->client()->review_time=='auto') {
            ...
            // return redirect()->route('admin.invoices.needsProcessed');
        } else {
            $invoice->status="Needs Sent From Finalized";
            $invoice->save();
            // Session::flash('message', "Just finalized invoice #".$invoice->invoice_number."."); 
            // return redirect()->route('admin.invoices.needsSent');
        }
        Session::flash('message', "Just finalized invoice #".$invoice->invoice_number."."); 
        return redirect()->route('admin.invoices.'.$request->from);
    }
    ...
    public function mark_sent(Request $request)
    {
        ...
        return redirect()->route('admin.invoices.pendingClientApproval');
    }
     ...
     public function recalculate(Request $request)
    {
        ...
        if ($invoice->invoice_method=='automatically'){
            return redirect()->route('admin.invoices.automatic');
        }else{
            return redirect()->route('admin.invoices.manual');
        }
    }
    ...
    public function approvebyclient(Request $request)
    {
        ...
        if($client->payment_method=="client_process_ach"){
            ...
            // return redirect()->route('admin.invoices.bankVerifications');
        }else{
            $invoice->status="Needs Processed";
            $invoice->save();
            // Session::flash('message', "Invoice #".$invoice->invoice_number." approved by client."); 
    ...
    public function remove(Request $request)
    {
        ...
        return redirect()->route('admin.invoices.'.$from);
    }
    ...
    public function update(Request $request)
    {
        ...
        if (count($lines)==0) {
            ...
            return redirect()->route('admin.invoices.edit', ['id'=>$invoice->id,'from'=>$from]);
        }
