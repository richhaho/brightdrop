...
class DeclinedController extends Controller
{
    public function pendingNotice()
    {
        ...
        $declineds=DeclinedCandidates::where('status', 'Pending Notice')->get();
        ...
        return view('admin.declined.pendingNotice',$data);
    }
    ...
    public function completed()
    {
        ...
        $declineds=DeclinedCandidates::where('status', 'Completed')->get();
        $decline_reason = [
            '' => '',
            'Applicant Withdrew' => 'Applicant Withdrew',
            'Client Declined' => 'Client Declined',
        ...
        return view('admin.declined.completed',$data);
    }
