...
class ContactController extends Controller
{
    public function create()
    {
        ...
        $clients_list=Clients::where('deleted_at',null)->get()->pluck('client_name','id');
    ...
    { 
        ...
        $contact->account_managers_id=0;
        $contact->admins_id=Auth::user()->admin()->id;
    ...
    public function profile($id)
    {
        ...
        return view('admin.contact.profile',$data);
    }
    ...
    { 
        ...
        if (count(User::where('id','!=',$contact->user_id)->where('email',$data['user_email'])->get())>0){
            Session::flash('message',"User email already exists. Please input unique user email.");
            return redirect()->route('admin.contact.profile',$contact->id);
        }
    ...
    public function search()
    {
        ...
        $contacts=Contacts::where('deleted_at',null)->where('deleted_at',null);
        ...
        return view('admin.contact.search',$data);
    }
    public function setfilter(Request $request)
    {
        ...
        return redirect()->route('admin.contact.search');
    }
    ...
    public function sendResetPasswordLink(Request $request)
    {
        ...
        return redirect()->route('admin.contact.profile',$id);
    }
