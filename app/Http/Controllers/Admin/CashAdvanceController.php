...
class CashAdvanceController extends Controller
{
    public function createCashAdvance()
    {
        ...
        return view('admin.cash_advance.createCashAdvance',$data);
    }
    public function openCashAdvance()
    {
        ...
        return view('admin.cash_advance.openCashAdvance',$data);
    }
    public function pastCashAdvance()
    {
        ...
        return view('admin.cash_advance.pastCashAdvance',$data);
    }
    ...
    public function submitCashAdvance(Request $request)
    {
        ...
        $cashAdvance->payroll_managers_id=0;
        ...
        return redirect()->route('admin.openCashAdvance');
    }
